...
import static utils.JsonReader.getJsonArrayData;
...
//check to my Git hub
    ...
    public void getUserData() {
        given().
                when().
                header("x-api-key","reqres_f34c20efc2f443b59ab52a1457483899").
    ...
    public void verifyStatusCodeDelete() {
        ...
        ExtentReport.test().info("DELETE Response status code: " + resp.getStatusCode());
    ...
    public void validateWithDataFromPropertiesFile() {
        ExtentReport.test().info("validateWithDataFromPropertiesFile");
    ...
    public void Test() throws IOException, ParseException {
        Object technology = getJsonArrayData("technology", 2);
